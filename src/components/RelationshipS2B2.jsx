   ...
   return (
      <div ref={ref} className="relative h-screen w-full overflow-hidden">
         ...
         >
            ...
            <p className="text-3xl leading-snug font-bold text-black" style={{ fontFamily: 'var(--font-secondary)' }}>
         ...
         <motion.div
            className="absolute top-80 left-20 max-w-1/2 text-left"
            initial={{ opacity: 0, y: 30 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
         ...
         >
            ...
            <div className="relative">
               <p className="text-2xl leading-snug font-base text-black" style={{ fontFamily: 'var(--font-secondary)' }}>
               ...
               <img
                  ...
                  className="absolute top-7 w-[120px] z-10"
               />
            </div>
            ...
            <div className="relative">
               ...
               <img
                  ...
                  className="absolute top-7 left-3 w-[120px] z-10"
               />
            </div>
         ...
         <div className="absolute bottom-15 right-25">
             <div className="relative w-64 h-64">
               ...
               <motion.img
                  src="/revolution.jpg"
                  alt="Debs cartoon"
                  className="absolute bottom-10 right-25 w-45 -rotate-10 z-10 shadow-lg"
               ...
               <motion.img
                  src="/superbase.jpg"
                  alt="Debs in prison"
                  className="absolute bottom-10 left-30 w-50 rotate-8 z-0 shadow-md"
                  initial={{ opacity: 0, y: 80 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
               ...
               <img
                  src="/marxlenin.jpg"
                  alt="Debs badge"
                  className="absolute bottom-0 left-[60px] w-40 h-40 rounded-full object-cover z-20 border-4 border-white shadow-xl" />
            </div>
         </div>
         ...
         <img
            ...
            className="absolute top-40 right-80 w-[150px] rotate-10 z-30"
         />
      </div>
   );
};
